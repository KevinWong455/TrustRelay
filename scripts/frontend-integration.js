 ...
 * This file demonstrates how to integrate Trustrelay with a web frontend
 */

// For React/Vue/Angular applications
export class TrustrelayClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TrustrelayClient(provider, contractAddress);
